    ...
    return new Promise((() => {
      var _ref3 = _asyncToGenerator(function* (resolve, reject) {
        ...
        if (pkg.license !== undefined) {
          ...
          const value = yield getGitHubLicense(pkg);
...
var _spdxExpressionParse = require('spdx-expression-parse');

var _spdxExpressionParse2 = _interopRequireDefault(_spdxExpressionParse);
...
function parseLicense(licenseName, pkg) {
  ...
  try {
    ...
    const parsedLicense = (0, _spdxExpressionParse2.default)(correctedVersion).license;
    return new _report_model.License(parsedLicense, _fetchLicenseUtility2.default.possibleOrigins['packagePropertyLicense']);
  } catch (err) {

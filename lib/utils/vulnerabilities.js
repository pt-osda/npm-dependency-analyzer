...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (dependencies, cacheTime) {
    ...
    const requestBody = _lodash2.default.flattenDeep(notFlatRequestBody);

    const [fetchError, response] = yield (0, _utilityFunctions2.default)((0, _isomorphicFetch2.default)(getRequest(requestBody, cacheTime)));
    if (fetchError) {
    ...
    _fileManager2.default.writeBuildFile('api-vulnerabilities.json', JSON.stringify(body));
      ...
      dependencyVulnerabilities.forEach(function (elem) {
        ...
        elem.vulnerabilities.forEach(function (vulnerability) {
          if (!dependency.vulnerabilities.some(function (depElem) {
            ...
            dependency.vulnerabilities.push(new _report_model.Vulnerability({
              id: vulnerability.id,

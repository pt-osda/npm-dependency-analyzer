...
exports.default = function () {
  ...
  (0, _dependencies2.default)((() => {
    var _ref = _asyncToGenerator(function* (dependenciesError, { pkg, dependencies }) {
      ...
      const [reportError, reportInfo] = yield (0, _utilityFunctions2.default)((0, _isomorphicFetch2.default)(getRequest(report)));
      if (reportError) {
        throw new Error(`VulnerabilityError: ${vulnerabilitiesError.message}`);
      }
    });
...
function generateReport(pkg, dependencies) {
  const report = new _report_model.Report(pkg.version, pkg.name, pkg.description, new Date(Date.now()).toISOString());
  let i = 0;

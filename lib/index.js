...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (policyData) {
    ...
    const [dependenciesError, { pkg, dependencies }] = yield (0, _utilityFunctions2.default)((0, _dependencies2.default)());
    ...
    const [reportError] = yield (0, _utilityFunctions2.default)((0, _isomorphicFetch2.default)(getRequest(report)));
    if (reportError) {
      throw new Error(`VulnerabilityError: ${vulnerabilitiesError.message}`);
    }
  });
